 ...
 * By default success is determined by a 200 response, if custom
 * logic should be used to determine the success of a ping then
 * the heartbeatSuccessFunction should be set.  This function should
